...
var map_ConnectionProfile = map[string]string{
	"":             "ConnectionProfile is the desired profile for securing network connections.",
	"type":         "type is one of Old, Intermediate, Modern or Custom. Custom provides the ability to specify individual security parameters for network connections. Old, Intermediate and Modern are profiles based on:\n\nhttps://wiki.mozilla.org/Security/Server_Side_TLS#Recommended_configurations",
	"old":          "old is a network connection profile based on:\n\nhttps://wiki.mozilla.org/Security/Server_Side_TLS#Old_backward_compatibility\n\nand looks like this (yaml):\n\n  ciphers:\n    - ECDHE-ECDSA-CHACHA20-POLY1305\n    - ECDHE-RSA-CHACHA20-POLY1305\n    - ECDHE-RSA-AES128-GCM-SHA256\n    - ECDHE-ECDSA-AES128-GCM-SHA256\n    - ECDHE-RSA-AES256-GCM-SHA384\n    - ECDHE-ECDSA-AES256-GCM-SHA384\n    - DHE-RSA-AES128-GCM-SHA256\n    - DHE-DSS-AES128-GCM-SHA256\n    - kEDH+AESGCM\n    - ECDHE-RSA-AES128-SHA256\n    - ECDHE-ECDSA-AES128-SHA256\n    - ECDHE-RSA-AES128-SHA\n    - ECDHE-ECDSA-AES128-SHA\n    - ECDHE-RSA-AES256-SHA384\n    - ECDHE-ECDSA-AES256-SHA384\n    - ECDHE-RSA-AES256-SHA\n    - ECDHE-ECDSA-AES256-SHA\n    - DHE-RSA-AES128-SHA256\n    - DHE-RSA-AES128-SHA\n    - DHE-DSS-AES128-SHA256\n    - DHE-RSA-AES256-SHA256\n    - DHE-DSS-AES256-SHA\n    - DHE-RSA-AES256-SHA\n    - ECDHE-RSA-DES-CBC3-SHA\n    - ECDHE-ECDSA-DES-CBC3-SHA\n    - EDH-RSA-DES-CBC3-SHA\n    - AES128-GCM-SHA256\n    - AES256-GCM-SHA384\n    - AES128-SHA256\n    - AES256-SHA256\n    - AES128-SHA\n    - AES256-SHA\n    - AES\n    - DES-CBC3-SHA\n    - HIGH\n    - SEED\n    - \"!aNULL\"\n    - \"!eNULL\"\n    - \"!EXPORT\"\n    - \"!RC4\"\n    - \"!MD5\"\n    - \"!PSK\"\n    - \"!RSAPSK\"\n    - \"!aDH\"\n    - \"!aECDH\"\n    - \"!EDH-DSS-DES-CBC3-SHA\"\n    - \"!KRB5-DES-CBC3-SHA\"\n    - \"!SRP\"\n  securityProtocol:\n    minimumVersion: TLSv1.0\n    maximumVersion: TLSv1.2\n  dhParamSize: 1024",
	"intermediate": "intermediate is a network connection profile based on:\n\nhttps://wiki.mozilla.org/Security/Server_Side_TLS#Intermediate_compatibility_.28default.29\n\nand looks like this (yaml):\n\n  ciphers:\n    - ECDHE-ECDSA-CHACHA20-POLY1305\n    - ECDHE-RSA-CHACHA20-POLY1305\n    - ECDHE-ECDSA-AES128-GCM-SHA256\n    - ECDHE-RSA-AES128-GCM-SHA256\n    - ECDHE-ECDSA-AES256-GCM-SHA384\n    - ECDHE-RSA-AES256-GCM-SHA384\n    - DHE-RSA-AES128-GCM-SHA256\n    - DHE-RSA-AES256-GCM-SHA384\n    - ECDHE-ECDSA-AES128-SHA256\n    - ECDHE-RSA-AES128-SHA256\n    - ECDHE-ECDSA-AES128-SHA\n    - ECDHE-RSA-AES256-SHA384\n    - ECDHE-RSA-AES128-SHA\n    - ECDHE-ECDSA-AES256-SHA384\n    - ECDHE-ECDSA-AES256-SHA\n    - ECDHE-RSA-AES256-SHA\n    - DHE-RSA-AES128-SHA256\n    - DHE-RSA-AES128-SHA\n    - DHE-RSA-AES256-SHA256\n    - DHE-RSA-AES256-SHA\n    - ECDHE-ECDSA-DES-CBC3-SHA\n    - ECDHE-RSA-DES-CBC3-SHA\n    - EDH-RSA-DES-CBC3-SHA\n    - AES128-GCM-SHA256\n    - AES256-GCM-SHA384\n    - AES128-SHA256\n    - AES256-SHA256\n    - AES128-SHA\n    - AES256-SHA\n    - DES-CBC3-SHA\n    - \"!DSS\"\n  securityProtocol:\n    minimumVersion: TLSv1.0\n    maximumVersion: TLSv1.2\n  dhParamSize: 2048",
	"modern":       "modern is a network connection profile based on:\n\nhttps://wiki.mozilla.org/Security/Server_Side_TLS#Modern_compatibility\n\nand looks like this (yaml):\n\n  ciphers:\n    - ECDHE-ECDSA-AES256-GCM-SHA384\n    - ECDHE-RSA-AES256-GCM-SHA384\n    - ECDHE-ECDSA-CHACHA20-POLY1305\n    - ECDHE-RSA-CHACHA20-POLY1305\n    - ECDHE-ECDSA-AES128-GCM-SHA256\n    - ECDHE-RSA-AES128-GCM-SHA256\n    - ECDHE-ECDSA-AES256-SHA384\n    - ECDHE-RSA-AES256-SHA384\n    - ECDHE-ECDSA-AES128-SHA256\n    - ECDHE-RSA-AES128-SHA256\n  securityProtocol:\n    minimumVersion: TLSv1.2\n    maximumVersion: TLSv1.2\n  dhParamSize: 2048",
	"custom":       "custom is a user-defined network connection profile. Be extremely careful using a custom profile as invalid configurations can be catastophic. An example custom profile looks like this:\n\n  ciphers:\n    - ECDHE-ECDSA-CHACHA20-POLY1305\n    - ECDHE-RSA-CHACHA20-POLY1305\n    - ECDHE-RSA-AES128-GCM-SHA256\n    - ECDHE-ECDSA-AES128-GCM-SHA256\n  securityProtocol:\n    minimumVersion: TLSv1.1\n    maximumVersion: TLSv1.2\n  dhParamSize: 1024",
}

func (ConnectionProfile) SwaggerDoc() map[string]string {
	return map_ConnectionProfile
}

var map_ConnectionProfileSettings = map[string]string{
	"":                 "ConnectionProfileSettings defines the settings of a network connection profile. If any field is unset, ConnectionProfileSettings is considered invalid.",
...
func (ConnectionProfileSettings) SwaggerDoc() map[string]string {
	return map_ConnectionProfileSettings
}

var map_CustomConnectionProfile = map[string]string{
	"": "CustomConnectionProfile defines the schema for a custom network connection profile.",
}

func (CustomConnectionProfile) SwaggerDoc() map[string]string {
	return map_CustomConnectionProfile
}

var map_SecurityProfile = map[string]string{
	"":       "SecurityProfile defines the schema for a security profile. This object is used by operators to apply security settings to operands.",
	"spec":   "spec is the specification of the desired behavior of the SecurityProfile.",
	"status": "status is the most recently observed status of the SecurityProfile.",
}
...
var map_SecurityProfileList = map[string]string{
	"": "SecurityProfileList contains a list of SecurityProfiles.",
}

func (SecurityProfileList) SwaggerDoc() map[string]string {
	return map_SecurityProfileList
}

var map_SecurityProfileSpec = map[string]string{
	"":                  "SecurityProfileSpec is the desired security profile configuration.",
	"connectionProfile": "connectionProfile defines the schema for a securing network connections.",
}
...
var map_SecurityProfileStatus = map[string]string{
	"":                          "SecurityProfileStatus defines the observed status of the SecurityProfile.",
	"connectionProfileSettings": "connectionProfileSettings is the actual network connection settings of the security profile in use.",
}

func (SecurityProfileStatus) SwaggerDoc() map[string]string {
	return map_SecurityProfileStatus
}
