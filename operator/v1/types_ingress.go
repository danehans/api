...
type IngressControllerSpec struct {
	...
	//
	// +optional
	SecurityProfile *configv1.SecurityProfileSpec `json:"cecurityProfile,omitempty"`
}
...
type IngressControllerStatus struct {
	...
	ConnectionProfileSettings *configv1.ConnectionProfileSettings `json:"connectionProfileSettings,omitempty"`
